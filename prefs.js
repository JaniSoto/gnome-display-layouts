...
const ACTIONS = ['apply', 'toggle', 'save', 'cycle'];
    ...
    fillPreferencesWindow(window) {
        ...
        const createGenericSlot = (prefGroup, slotIndex) => {
            ...
            combo.connect('notify::selected', () => {
                ...
                targetRow.visible = isTargetVisible(actionStr);
            });
